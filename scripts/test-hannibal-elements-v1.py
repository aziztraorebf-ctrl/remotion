"""
Kling O3 — Hannibal armée apparait — avec ELEMENTS
Correction du defaut du clip masterpiece : soldats qui derivent semi-realiste.

Technique : start+end frame + elements (Hannibal REF + soldat type REF)
Endpoint  : fal-ai/kling-video/o3/standard/image-to-video
Ref masterpiece : tmp/brainstorm/references/hannibal-army-appear-MASTERPIECE.mp4

@Element1 = Hannibal canonical (portrait REF)
@Element2 = soldat type (silhouette noire, bouclier violet, meme style)
"""
...
OUTPUT      = Path(__file__).parent.parent / "tmp/brainstorm/hannibal-elements-v1.mp4"
...
if __name__ == "__main__":
    ...
    print(f"\n=== Kling O3 + elements — Hannibal armée v1 ===")

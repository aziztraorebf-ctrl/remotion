"""
Beat02 — Kling O3 regeneration a 12s (v2)
Start frame : beat04-name-scene-v2.png (roi sur trone plan large — identique au clip actuel)
End frame   : beat02-endframe-westlook.png (portrait frontal/3-4 expressif — variante v1)
Duree       : 12s (beat empire = 12.08s)
cfg_scale   : 0.4
Output      : beat02-o3-westlook-v2.mp4
"""
...
END_IMAGE = ASSETS_DIR / "beat02-endframe-westlook.png"
OUTPUT = ASSETS_DIR / "beat02-o3-westlook-v2.mp4"
...
def main():
    print("=== Beat02 O3 v2 — end frame portrait 3/4 (12s) ===\n")

    print("Upload start frame (roi sur trone)...")
    start_url = fal_client.upload_file(str(START_IMAGE))
    print(f"  start: {start_url}")

    print("Upload end frame (portrait frontal/3-4 expressif)...")

"""
Beat05 Plan 1 — Mansa Moussa — Grandeur Reveal v3 — 10s
Correction v2 : retrait mouvement robe (causait soulèvement bizarre)
Conserve : Dolly Out valide + clignements
Source : mansa-moussa-fullshot.png
Modele : V3 Pro, cfg_scale 0.35, 10s
Output : public/assets/geoafrique/beat05-moussa-grandeur-v3.mp4
"""
...
OUTPUT_PATH = Path(__file__).parent.parent / "public/assets/geoafrique/beat05-moussa-grandeur-v3.mp4"
...
PROMPT = (
    ...
    "His entire body is completely still — robe, hands, and clothing are perfectly motionless. "
...
NEGATIVE_PROMPT = (
    ...
    "fabric movement, cloth simulation, robe movement, clothing animation"
)
...
def generate():
    print("=== Beat05 Plan 1 — Grandeur Reveal v3 — robe statique ===")

"""
Amanirenas O3 V2B — end frame corrigee (soldats en bas, pas plein cadre) + duree 8s
Test : end frame accessible depuis trajectoire naturelle = moins de remontee ?
"""
...
OUTPUT_PATH = Path(__file__).parent.parent / "tmp/brainstorm/amanirenas-o3-v2b-10s.mp4"
...
def generate_clip(start_url: str, end_url: str) -> str | None:
    print("\n=== Amanirenas O3 V2B — 8s, end frame corrigee ===")

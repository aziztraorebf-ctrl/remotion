"""
Beat05 Plan 2 — Caravane v2 — Kling O3 Dolly In
Source : beat05-plan2-caravan-v3.png (sans rayons, sans bande noire)
Modele : O3 Standard, cfg_scale 0.35, 8s
Output : public/assets/geoafrique/beat05-plan2-caravan-v2.mp4
"""
...
OUTPUT_PATH = Path(__file__).parent.parent / "public/assets/geoafrique/beat05-plan2-caravan-v2.mp4"
...
NEGATIVE_PROMPT = (
    ...
    "sky animation, pulsing light, lens flare"
)
...
def generate():
    print("=== Beat05 Plan 2 — Caravane Dolly In v2 — O3 Standard ===")

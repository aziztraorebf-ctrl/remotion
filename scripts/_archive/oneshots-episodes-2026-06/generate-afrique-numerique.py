"""Generate narration Short Analyste — Qui possède l'Afrique numérique."""
import os
import sys
import subprocess
...
SCRIPT_FILE = ROOT / "src" / "projects" / "_demos" / "afrique-numerique" / "script-tts.txt"
NARRATION = SCRIPT_FILE.read_text(encoding="utf-8").strip()

OUT_DIR = ROOT / "public" / "_demos" / "afrique-numerique" / "audio"

"""Generate narration Short — Le pétrole de la patience (~90s)."""
import os
import sys
import subprocess
...
SCRIPT_FILE = ROOT / "src" / "projects" / "_demos" / "petrole-patience" / "script-short-tts.txt"
NARRATION = SCRIPT_FILE.read_text(encoding="utf-8").strip()

OUT_DIR = ROOT / "public" / "_demos" / "petrole-patience" / "audio"
OUT_FILE = OUT_DIR / "narration-short-v1.mp3"

/**
 * Precompute SVG paths pour "La Vraie Taille de l'Afrique"
 *
 * Projection : geoMercator centree sur Afrique, meme echelle que la vue finale
 * Output : src/projects/souverain/vraie-taille-afrique/geo-data.json
 *
 * Usage : node scripts/precompute-vraie-taille.mjs
 */
...
// Projection Mercator — echelle calibree pour que l'Afrique remplisse ~70% du cadre 9:16
// scale 420 = zoom ~2.7 Mapbox equivalent pour 1080px de large
// center lat=-5 pour laisser de la marge en haut (Mediterranee visible)
// translate Y = HEIGHT * 0.45 remonte lAfrique vers le haut du cadre 9:16
...
const outPath = "src/projects/souverain/vraie-taille-afrique/geo-data.json";

"""Generate narration — Le pétrole de la patience (démo Mapbox techniques).
...
SCRIPT_FILE = ROOT / "src" / "projects" / "_demos" / "petrole-patience" / "script-tts.txt"
...
def main() -> int:
    ...
    print("AUTO MODE — generating without confirmation")
    print()

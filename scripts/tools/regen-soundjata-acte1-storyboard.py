"""Regen Soundjata Acte I storyboard: 6 panels 2x3 (overwrites 9-panel version).
...
REFS = [
    ...
    REFS_DIR / "acte1/village-children-ref.png",
]

OUTPUT = REFS_DIR / "acte1/storyboard-6panels.png"
...
- Image 4 = baby Soundjata toddler 3-4 years old (panel 6)
- Image 5 = village children (panel 5)
...
PANEL 5 (bottom-center) - LABEL: "WIDE CHILDREN PLAYING"
3-4 Mandingue children running joyfully in a DAYTIME village (tonal shift from night to day shows time passing). Banco earthen houses in the background, ochre dust.

PANEL 6 (bottom-right) - LABEL: "CLOSE BABY SOUNDJATA"
Close-up of baby Soundjata, a toddler 3-4 years old, sitting ALONE on the ochre ground of the village courtyard. Ochre tunic. Dignified gaze despite his solitude. NO other children in this frame - he is isolated. Emotional contrast with panel 5.

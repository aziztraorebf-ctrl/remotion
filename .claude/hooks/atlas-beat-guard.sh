...
echo "RGB CHECK : verifier que RGB > 80 sur fond ocean avant integration (asset invisible sinon)"
echo "REGISTRATION : verifier que le beat est enregistre dans Root.tsx avant premier render"
echo "--------------------------------------"

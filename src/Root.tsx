...
import { RecapEntranceRev2, RECAP_ENTRANCE_REV2_FRAMES } from "./projects/_rnd/chill-meter/RecapEntranceRev2";
...
import { Plan06GoogleEarth } from "./projects/_client-sim/foster/scenes/Plan06GoogleEarth";
...
import { FosterFull, FOSTER_TOTAL } from "./projects/_client-sim/foster/FosterFull";
  ...
  return (
    <>
      ...
      <Folder name="atlas-peste-1347">
        ...
        <Composition
          id="FosterPlan09"
          component={Plan09PullBack}
          durationInFrames={30}
          fps={30}
          width={1920}
          height={1080}
        />
        {/* FOSTER plan 8 : 23,40 -> 27,07 s = 110 frames a 30 fps.
            2 SOUS-PLANS separes par une coupe MESUREE a 25,05 s (frame 49). */}
        <Composition
          id="FosterPlan08"
          component={Plan08Dashboard}
          durationInFrames={110}
          fps={30}
          width={1920}
          height={1080}
        />
        {/* FOSTER plan 7 : 18,45 -> 23,40 s = 148 frames a 30 fps.
            Fin MESUREE a 23,40 (le tableau annoncait 25,06). */}
        <Composition
          id="FosterPlan07"
          component={Plan07Maison}
          durationInFrames={148}
          fps={30}
          width={1920}
          height={1080}
        />
        {/* FOSTER plan 6 : 17,40 -> 18,45 s = 32 frames a 30 fps.
            Bornes MESUREES (le tableau annoncait 18,03 -> 18,41). */}
        <Composition
          id="FosterPlan06"
          component={Plan06GoogleEarth}
          durationInFrames={32}
          fps={30}
          width={1920}
          height={1080}
        ...
        <Composition
          id="FosterPlan04"
          component={Plan04Assembles}
          durationInFrames={65}
          fps={30}
          width={1920}
          height={1080}
        />
        {/* FOSTER plan 3 : 5,597 -> 11,44 s = 175 frames a 30 fps. */}
        <Composition
          id="FosterPlan03"
          component={Plan03Typo}
          durationInFrames={175}
          fps={30}
          width={1920}
          height={1080}
        />
        {/* FOSTER plan 2 : 1,602 -> 5,597 s = 120 frames a 30 fps (coupes MESUREES). */}
        <Composition
          id="FosterPlan02"
          component={Plan02NotifStack}
      ...
      <Composition
        ...
        durationInFrames={VECTOR_PLAT_FRAMES}
        fps={VECTOR_PLAT_FPS}
        width={1920}
        height={1080}
      />
      ...
      {/* --- merge master 2026-08-20 : registre stick-figures (branche rnd/stick-figures-gestes) --- */}
      ...
      <Folder name="RND-ChillMeter">
        ...
        <Composition
          ...
          defaultProps={{ mutePlateau: true }}
        />
        {/* ⭐ 11/09 — 2e revision du jalon 2 : ENTRANCE SEULE + carton d'ouverture.
            Ses 4 demandes du 11/09 sont toutes dans l'entrance ; le 0-25 %, deja vu et
            non commente, n'est pas remontre. */}
        <Composition
          id="ChillMeter-RECAP-EntranceRev2-AvecSonPlateau"
          component={RecapEntranceRev2}
          durationInFrames={RECAP_ENTRANCE_REV2_FRAMES}
          fps={30}
          width={1920}
          height={1080}
          defaultProps={{ mutePlateau: false }}
        />
        <Composition
          id="ChillMeter-RECAP-EntranceRev2-SansSonPlateau"
          component={RecapEntranceRev2}
          durationInFrames={RECAP_ENTRANCE_REV2_FRAMES}
          fps={30}
          width={1920}

...
| **Poser une DONNÉE majeure** (chiffre sans équivalent carto : famine, PIB) | `WarMapDataOverlay` (variant solide) | `engine/WarMapDataOverlay.tsx` | Fond SOLIDE parchemin, centré, fige l'action 7-10s. N icônes exactes (1=1 unité) |
| **Expliquer ce qui se passe sur la carte** (exode, contexte) | overlay explicatif (texte sur carte) | `engine/WarMapEngine.tsx` (bloc texte-réfugiés) | Fond SEMI-TRANSPARENT, centré (jamais en haut), coupe l'action |

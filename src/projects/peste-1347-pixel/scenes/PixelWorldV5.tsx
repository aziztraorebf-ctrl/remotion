...
// ============================================================
// PIXEL WORLD V5 - AI-generated ground replacing tiled ground
//
// 10 seconds @ 30fps = 300 frames
// Same as V4 (camera motion, data overlays, narrative HUD, reduced night)
// CHANGE: Ground uses GPT Image 1 AI-generated cobblestone (ground-ai.png)
//         instead of repeating 320px tile. 1536x256 native resolution.
//
...
const GROUND_H = 160; // V5: AI ground is 160px tall (was 128 in V4)
...
// ============================================================
// Ground - AI-generated cobblestone (GPT Image 1)
// ground-ai.png: 1536x256 native resolution, tiled horizontally
// Displayed at 160px height (slightly taller than V4's 128px for more detail)
// ============================================================
const AI_GROUND_SRC = "assets/peste-pixel/town/extracted/ground-ai.png";
const AI_GROUND_W = 1536; // native width
const AI_GROUND_DISPLAY_H = 160; // slightly taller than V4's 128px

const Ground: React.FC<{ scrollPos: number }> = ({ scrollPos }) => {
  const scrollX = -(scrollPos * 1.5) % AI_GROUND_W;
  const tilesNeeded = Math.ceil(1920 / AI_GROUND_W) + 2;

  return (
    <>
      {/* Opaque backdrop - prevents parallax bleed under ground */}
      <div
        style={{
          position: "absolute",
          bottom: 0,
...
// MAIN COMPOSITION
// ============================================================
export const PixelWorldV5: React.FC = () => {

...
| ⭐ **Main-curseur, 3 poses** (repos / appui / pointe) — DESSINÉE avec référence | `elements/ui/main-curseur-3poses.svg` | — (doc inline) | Interface / démo produit mobile | Concours SVG 2026-08-28. ⛔ Registre où 5 modèles sur 5 échouent **sans référence** — lire `.claude/agent-memory/svg-dessinateur/ECHECS.md` avant d'en redemander une |

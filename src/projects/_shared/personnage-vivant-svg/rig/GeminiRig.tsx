 ...
 *
 * Deplace depuis src/projects/_rnd/svg-scenes/ProtoGeminiPoseBankWalk.tsx (proto -> production, 2026-07-03).
 * Le proto garde un re-export temporaire pour ne rien casser.
 */

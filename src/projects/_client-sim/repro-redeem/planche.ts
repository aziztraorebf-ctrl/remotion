...
export const VIGNETTE_GIFTCARD = `<g id="vignette-giftcard-carte">
      ...
      <rect x="338" y="142" width="124" height="170" rx="16" fill="#ffffff" stroke="#e8e6f5" stroke-width="1.5"/>
    </g>
...
export const VIGNETTE_CASH = `<g id="vignette-cash-carte">
      ...
      <rect x="338" y="394" width="124" height="170" rx="16" fill="#ffffff" stroke="#e8e6f5" stroke-width="1.5"/>
    </g>

...
export const DOC = `<path id="doc-ombre-pied" d="M6 133.6 L105 133.6 C105 134.5 104.3 135 103.4 135 L7.6 135 C6.7 135 6 134.5 6 133.6 Z" fill="#0d3847" opacity="0.16"/>
    <path id="doc-corps" d="M1.2 135 C0.5 135 0 134.5 0 133.8 L0 1.2 C0 0.5 0.5 0 1.2 0 L89 0 L111 20.6 L111 133.8 C111 134.5 110.5 135 109.8 135 L1.2 135 Z" fill="#f7f1e2"/>
    ...
    <path id="doc-liseré-gauche" d="M0 1.2 C0 0.5 0.5 0 1.2 0 L5.4 0 L5.4 135 L1.2 135 C0.5 135 0 134.5 0 133.8 Z" fill="#f7f1e2" opacity="0.9"/>
    <path id="doc-corne-dessous" d="M111 20.6 L89 20.6 L89 0 Z" fill="#0d3847" opacity="0.13"/>
    <path id="doc-corne-rabat" d="M111 20.6 L89 20.6 L89 0 Z" fill="#f7f1e2"/>
    ...
    <g id="doc-lignes-texte">
      <rect id="doc-ligne-1" x="18.7" y="38.5" width="73.6" height="2.6" rx="1.3" fill="#0d3847"/>
      <rect id="doc-ligne-2" x="18.7" y="45.2" width="73.6" height="2.6" rx="1.3" fill="#0d3847"/>
      <rect id="doc-ligne-3" x="18.7" y="51.8" width="73.6" height="2.6" rx="1.3" fill="#0d3847"/>
      <rect id="doc-ligne-4" x="18.7" y="58.5" width="73.6" height="2.6" rx="1.3" fill="#0d3847"/>
      <rect id="doc-ligne-5" x="18.7" y="65.2" width="73.6" height="2.6" rx="1.3" fill="#0d3847"/>
      <rect id="doc-ligne-6" x="18.7" y="71.9" width="73.6" height="2.6" rx="1.3" fill="#0d3847"/>
      <rect id="doc-ligne-7" x="18.7" y="78.5" width="73.6" height="2.6" rx="1.3" fill="#0d3847"/>
      <rect id="doc-ligne-8" x="18.7" y="85.2" width="73.6" height="2.6" rx="1.3" fill="#0d3847"/>
      <rect id="doc-ligne-9" x="18.7" y="91.9" width="73.6" height="2.6" rx="1.3" fill="#0d3847"/>
      <rect id="doc-ligne-10" x="18.7" y="98.5" width="49.1" height="2.6" rx="1.3" fill="#0d3847"/>
    </g>

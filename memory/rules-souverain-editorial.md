...
> **Règles SCRIPT & TITRE (sections 5, 7, 9) → `memory/rules-souverain-script.md`** (acteurs, TTS, format Short vs Long, titre hybride, vulgarisation, 140 mots).
>
...
> Déplacé vers `memory/rules-souverain-script.md` (acteurs explicites, TTS français, vulgarisation). Consulter ce fichier pour les règles script.
...
> Déplacé vers `memory/rules-souverain-script.md` (test "image dans la tête", gate Short, mode de traitement, amputation). Consulter ce fichier.
...
> Déplacé vers `memory/rules-souverain-script.md` (titre hybride, vulgarisation universelle, 140 mots, tests Tokyo/Nairobi/14ans, R-MOTIVATION-VISIBLE). Consulter ce fichier.

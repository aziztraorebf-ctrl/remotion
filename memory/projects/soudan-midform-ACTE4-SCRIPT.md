# SOUDAN ACTE 4 — « MÊME LES VOISINS SONT ASPIRÉS » — SCRIPT v5

> Suite de [[soudan-midform-ACTE3-SCRIPT]]. Décision de structure actée avec Aziz (2026-07-10) :
...
> 2e jury (densité cumulative/flux narratif) a détecté une rupture logique invisible au 1er jury →
> réordonnancement des beats → v4. **v5 : 2 corrections manuelles Aziz** — (1) "Le Caire" éliminé
> entièrement (même en occurrence unique, il restait une variation évitable) au profit de "l'Égypte"
> partout, cohérence totale sur tout l'acte ; (2) beat 6 final : "Elle n'a rien fait" (jugement
> accusateur implicite, suppose l'inaction délibérée) → "elle est restée inactive" (neutre, ne préjuge
> pas si des tentatives passées ont échoué ou si l'inaction est totale — cohérent avec la doctrine
> neutralité clinique du projet) + liaison par "Et" entre les deux phrases du beat pour lier le constat
> à sa conséquence plutôt que deux assertions juxtaposées. Détail complet dans la section JURY
> DENSITÉ/FLUX plus bas. Calibrage visé : ~70-90s.

## ✅ STATUT DES FAITS — VERROUILLÉ (Sonar Pro + Tavily de contrôle, 2026-07-10)

Passe 1 : Tavily (ISPI, GIS Reports, Jamestown, CNN 2023, Wikipedia, Horn Review, Soufan Center, Georgetown
GSSR, ADF Magazine). Passe 2 : Sonar Pro (`perplexity/sonar-pro`) sur les 7 affirmations — a nuancé 5/7 et
déclaré 2/7 NON VÉRIFIABLE (comportement connu, cf [[FACT-CHECK-DEEP-RESEARCH-VS-SONAR]] : Sonar est prudent,
rate parfois des faits que Tavily a). Passe 3 : Tavily ciblé sur les 2 points non vérifiables → tranchés.

**Faits verrouillés pour l'écriture (formulations à utiliser) :**
1. **Wagner/Meroe Gold** sanctionnée UE 2023 pour exploitation aurifère au Soudan, lien RSF ère Prigojine — FAIT solide (CNN + texte UE officiel). ✅ Inchangé.
2. **Bascule russe RSF→SAF** — CONFIRMÉE mais date précisée : **mai 2024**, accord Burhan-Russie pour un centre logistique + armes (ADF Magazine), pas "fin avril" comme la 1re synthèse le suggérait. Formulation retenue : "depuis 2024" (pas de date au jour près, prudence Sonar justifiée ici).
3. **Centre logistique / accès mer Rouge** — l'accord de mai 2024 (ci-dessus) EST ce centre logistique. ⚠️ Correction : PAS un second épisode "mai 2025" comme la 1re note le suggérait — un seul et même dossier qui évolue en continu 2024→2026, pas deux dates distinctes. Fusionné avec le point 4 ci-dessous.
4. **✅ TRANCHÉ (Tavily ciblé) — Offre de base navale, bien plus concrète que "non vérifiable" ne le suggérait** : Asharq Al-Awsat (source arabe fiable, citant sources US et soudanaises) rapporte une offre **précise et chiffrée** : accord de **25 ans**, jusqu'à **300 soldats russes + 4 navires de guerre (dont des bâtiments à propulsion nucléaire)** à Port-Soudan ou ailleurs sur la mer Rouge, contre des armes. Corroboré indépendamment par Horn Institute, Lansing Institute, Aspenia. **Statut mi-2026 : dossier actif, en cours, PAS encore signé** ("Russia Keeps Red Sea Base Plan Alive", suivi juillet 2026) — formulation correcte : "en discussion depuis 2024, pas encore conclu" plutôt que "acceptée" ou "refusée". Le point Madagascar (alternative russe) reste NON confirmé indépendamment — à retirer du script (détail non essentiel).
5. **Égypte : soutien direct au SAF** — CONFIRMÉ dans son principe par BBC Afrique + Reuters/NYT (via Horn Review) : accusations récurrentes de transfert de drones/aide militaire. ⚠️ Les détails très précis (nom "Oweinat", date exacte "déc 2025/janv 2026" pour la salle d'opérations) restent de sources secondaires seulement (pas de doc primaire type Amnesty) — garder le PRINCIPE (soutien direct, pas juste financier) mais éviter d'affirmer le nom de la base en dur à l'écran sans un 2e recoupement. Formulation retenue : "renseignement, base aérienne, coordination directe" sans nommer "Oweinat" explicitement à l'oral (le lieu peut apparaître à l'écran comme repère carte, pas verrouillé en voix).
6. **❌ RETIRÉ — Kosti / officiers égyptiens tués.** Tavily ciblé ne trouve AUCUNE trace d'officiers égyptiens tués à Kosti. Ce que Tavily trouve à Kosti : une frappe de drone RSF sur une **station-service civile** (21 juin 2026, 1 à 4 morts civils selon sources — Sudan Doctors Network vs autres), dans un contexte plus large de frappes sur civils (école Shukeiri 17 morts, hôpital al-Jabalain MSF 10 morts). Le "bilan officiers égyptiens" du script v1 était une confabulation de la 1re synthèse — **beat 4 à réécrire entièrement** (voir plus bas), soit en retirant le fait Kosti soit en le remplaçant par le vrai fait (coût civil du champ de bataille de proxys, cohérent avec le thème mais SANS l'invention).
7. **Motif Égypte** (rivalité EAU + GERD/Nil) — NUANCÉ par Sonar mais confirmé indépendamment par Georgetown GSSR (source distincte, motif ancien et bien documenté : lien SAF-Égypte historique via coopération GERD). ✅ Gardé, formulé comme "un" motif parmi d'autres plutôt que LE motif unique.

**Conclusion fact-check** : 5/7 faits tiennent avec ajustement de formulation, 1/7 se renforce (base navale,
plus concret que prévu), 1/7 est FAUX et retiré (Kosti officiers égyptiens). Le beat 4 du script ci-dessous
DOIT être réécrit avant jury LLM.
...
VOIX : Au début du conflit, des réseaux liés à Wagner armaient les paramilitaires. En échange, ils récupéraient de l'or soudanais.

VOIX : Puis en 2024, Moscou fait volte-face : son aide va désormais à l'armée régulière.
...
VOIX : Et la Russie n'est pas seule à se rapprocher de l'armée soudanaise. Au nord du Soudan, l'Égypte ne se contente plus de regarder.

CARTE : un marqueur part de l'Égypte (repère "Le Caire", trait court car proche) vers le jeton SAF — mais contrairement aux flèches précédentes (or, drones), celui-ci n'apporte pas un objet qui voyage : le halo bleu du jeton SAF se renforce directement à son arrivée (support direct, pas une livraison isolée).

VOIX : Son soutien passe surtout par le renseignement. Elle coordonne aussi avec les généraux soudanais — moins visible que les livraisons vues plus tôt, mais tout aussi réel.
...
VOIX : Ce ne sont donc plus seulement deux camps soudanais qui s'affrontent. Autour d'eux, quatre puissances étrangères ont chacune plus intérêt à peser sur l'issue de cette guerre qu'à la voir se terminer.

CARTE : dézoom qui cadre enfin les QUATRE flèches externes ensemble (EAU, Turquie, Russie, Égypte) autour du duo RSF/SAF au centre. Aucun texte, juste la densité visuelle qui parle.

VOIX (pont vers Acte 5, ne referme pas la boucle) : Et pourtant, une organisation existe pour arrêter exactement ce genre de guerre. Et, jusqu'à présent, elle est restée inactive.

---

## ✅ JURY LLM — VERDICT ET CORRECTIONS APPLIQUÉES (2026-07-10)

Jury 3 modèles (Gemini 3.1 Pro, GPT-5.5, Kimi k2.5 — coupé par limite de tokens mais convergent sur les
points atteints) sur le script v2 complet. **Verdict global convergent : AJUSTEMENTS MINEURS** (indépendamment
sur les 3 modèles). Script complet + verdicts détaillés archivés : scratchpad session, non versionné (texte
intégral des 3 verdicts conservé dans cette section sous forme de corrections tracées).

⚠️ **Point de vigilance sur le jury lui-même** : Gemini a affirmé à tort que la guerre durait "un peu moins
de 2 ans" pour contester le "trois ans" du beat 1 — vérification manuelle (15 avril 2023 → 10 juillet 2026
= 1182 jours = 3,24 ans) confirme que le script avait RAISON et que c'est le jury qui s'est trompé. Rappel
doctrine : LLM = signal, jamais juge — vérifier dans le réel avant d'appliquer un verdict, même unanime.

**3 défauts unanimes (3/3 modèles), corrigés :**
1. **"Cinq pays" au beat 6 était confus** (RSF/SAF ne sont pas des pays, seulement 4 acteurs externes réels) → beat 6 réécrit : "quatre puissances étrangères", flèches carte corrigées à 4.
2. **Beat 2 (base navale) restait une liste chiffrée dense** même après ma correction précédente → éclaté en 3 phrases séparées ("Moscou négocie... L'accord porterait sur vingt-cinq ans. Il autoriserait..."), carte simplifiée (1 icône fixe au lieu d'un compteur qui défile, pour éviter l'effet "jeu vidéo RTS" signalé par Gemini).
3. **Beat 4 (Kosti) créait une causalité implicite fausse avec l'Égypte** (placé juste après le beat Égypte, sans lien) → phrase de liaison ajoutée ("quand la guerre se sophistique ainsi, le front cesse d'être une ligne...") + attribution explicite du drone aux paramilitaires (sourcé Tavily, RSF confirmé).

**Points additionnels appliqués (pas unanimes mais argumentés, retenus car ils ajoutent de la profondeur) :**
- Beat 1 : "la Russie" nuancé en "des réseaux russes liés à Wagner" pour la période historique (avant 2024), "Moscou" réservé au rapprochement institutionnel récent — plus défendable juridiquement/factuellement (GPT-5.5).
- Beat 3 : "un deuxième voisin" → "un voisin direct" (la Russie, traitée juste avant, n'est pas un voisin — incohérence sémantique, Gemini). "Ne livre ni or ni drones" (formule artificielle) retiré ; "renseigne... coordonne directement" adouci en "son soutien passe surtout par" (moins catégorique, cohérent avec des sources secondaires non-primaires, GPT-5.5+Gemini).
- Beat 5 : show-don't-tell manqué corrigé — le Nil s'illumine visuellement sur la carte pendant la phrase du motif (au lieu de "aucun nouveau marqueur", Gemini). Phrase coup de poing de clôture ajoutée ("Pour Le Caire, le Soudan n'est pas seulement un voisin. C'est une profondeur stratégique.", GPT-5.5).
- Beat 6 : "ont intérêt à ce que cette guerre continue" (sonnait trop cynique/intentionnel) → "ont plus intérêt à peser sur l'issue de cette guerre qu'à la voir se terminer" (plus fidèle au vrai mécanisme : ce n'est pas qu'ils veulent la guerre, c'est que la paix leur coûte plus cher, GPT-5.5).

**Non retenu à ce stade** : la suggestion Gemini de nuancer "personne à Moscou n'a retiré cette demande" en formulation encore plus prudente a été partiellement appliquée ("la demande russe reste sur la table" — plus sobre, moins journalistique).

---

## ✅ JURY LLM DENSITÉ/FLUX — 2e PASSE, CRITÈRES DIFFÉRENTS (2026-07-10) → v4

> Après le v3 (jury clarté phrase-par-phrase), Aziz a relu à voix haute et signalé un doute que le 1er
> jury ne pouvait pas voir : est-ce que l'acte ENTIER, lu d'une traite, reste digeste pour un spectateur
> lambda — pas juste chaque phrase individuellement ? Un 2e jury a été construit avec 5 critères
> spécifiquement DIFFÉRENTS du 1er (charge cognitive CUMULATIVE, continuité des désignations, test "et
> alors ?" strict phrase-à-phrase, test double-lecteur initié/lambda, flux narratif de bout en bout —
> PAS la clarté locale déjà validée). Gemini 3.1 Pro et GPT-5.5 ont répondu (Kimi k2.5 a timeout après
> 180s malgré `max_tokens` augmenté à 8000 — pas relancé, signal déjà net à 2/3).

**Verdict des 2 modèles répondants, quasi identique indépendamment** : scores 6,5/10 (Gemini) et 7/10
(GPT-5.5) — verdict AJUSTEMENTS MINEURS "mais structurels". **Diagnostic convergent, mot pour mot
similaire** : le script n'est PAS trop dense phrase par phrase (déjà corrigé au tour précédent), mais
**l'ORDRE des beats créait une fausse causalité et une rupture de flux** — le beat Kosti (ex-beat 4),
placé juste après le beat Égypte et avant le motif égyptien (ex-beat 5), laissait croire que la frappe de
drone RSF était liée au soutien égyptien. Citation Gemini : *"Le cerveau du spectateur va associer le
drone RSF à l'Égypte, ce qui est factuellement faux."* Citation GPT-5.5, même passage : *"Le spectateur
peut se demander : Est-ce que l'Égypte est liée à cette frappe ? Pourquoi parle-t-on de Kosti
maintenant ?"*

**Réordonnancement appliqué en v4 (identique proposé par les 2 modèles)** :
- Ancien ordre : Russie → base navale → Égypte (mode d'action) → Kosti → motif égyptien (Nil) → synthèse.
- **Nouvel ordre v4** : Russie → base navale → Égypte (mode d'action) → **motif égyptien (Nil, ex-beat 5,
  devient beat 4)** → **Kosti recadré (ex-beat 4, devient beat 5, reformulé "cette guerre alimentée de
  l'extérieur" — plus attribué à l'internationalisation générale, plus à l'Égypte spécifiquement)** →
  synthèse (beat 6, inchangé).

**Autres corrections appliquées (les 2 modèles convergent) :**
- Désignations stabilisées : "un voisin direct" (beat 3, introduisait une devinette inutile) retiré au
  profit d'un ancrage direct sur "l'Égypte" dès la 1re mention du beat 3 (via la phrase de transition "la
  Russie n'est pas seule à se rapprocher..."). "Le Caire" limité à UNE seule occurrence (la phrase de
  clôture "profondeur stratégique"), plus de va-et-vient Égypte/Le Caire dans la même respiration.
- Beat 1 : phrase surchargée ("Depuis le début de la guerre, il y a trois ans, des réseaux russes liés à
  Wagner armaient les paramilitaires et en tiraient de l'or en retour") scindée en 2 phrases distinctes
  (le fait Wagner/or, PUIS séparément la bascule 2024) — 3 marches cognitives au lieu d'un bloc.
- Beat 2 : "dont certains à propulsion nucléaire" isolé en fin de phrase séparée ("Certains pourraient
  être à propulsion nucléaire.") plutôt que noyé dans l'énumération des chiffres.
- Beat 5 (ex-beat 4, Kosti) : phrase de liaison recadrée sur l'internationalisation générale plutôt que
  sur l'Égypte spécifiquement ("cette guerre alimentée de l'extérieur change de forme" au lieu de "la
  guerre se sophistique ainsi" qui suivait directement le beat Égypte) ; la phrase Kosti elle-même
  scindée en 3 unités courtes ("À Kosti, le 21 juin 2026, les paramilitaires frappent avec un drone. La
  cible est une station-service. Des civils y attendaient de l'essence.") au lieu d'un seul bloc à 6
  éléments factuels empilés.
- Beat 3 : "renseigne l'armée soudanaise et coordonne directement" scindé en 2 phrases ("Son soutien
  passe surtout par le renseignement. Elle coordonne aussi avec les généraux soudanais...").

**Non retenu** : la reformulation complète de GPT-5.5 pour "influence rivale" (jugée trop vague par le
jury, proposait "un pouvoir hostile à ses intérêts") — gardé tel quel, la formulation actuelle reste
...
des beats parce qu'aucun de ses 5 critères ne portait sur le flux de bout en bout. Pour tout futur acte
(Acte 5 et au-delà) : après le jury clarté standard, prévoir un 2e passage explicitement dédié à la
densité cumulative et au flux narratif si le script comporte 4+ beats avec plusieurs acteurs/faits
nouveaux qui s'enchaînent.

---

## GATE D'ÉCRITURE — auto-check (à recocher avant présentation, DOCTRINE-SCRIPT-UNIFIEE)

> ⚠️ **2 corrections successives post-relecture Aziz (2026-07-10)** — même défaut racine relevé deux fois :
> **1re passe** : la gate cochait la règle 11bis au sens strict (sujet+verbe présent) mais ratait la 11ter
> (incarnation ≠ empiler du factuel). Le beat 2 initial ("Sur la table des négociations : une base...,
> vingt-cinq ans, jusqu'à trois cents soldats...") lisait comme une liste à puces énoncée à voix haute.
> **2e passe (Aziz a re-détecté le MÊME défaut dans ma propre correction)** : en éclatant la liste en
> fragments courts ("Vingt-cinq ans. Jusqu'à trois cents soldats russes. Quatre navires de guerre."), j'ai
> confondu "phrase courte" (règle 14, rythme syncopé) avec "fragment nominal sans sujet-verbe" — un
> fragment reste télégraphique même court ; le rythme syncopé veut une PHRASE COMPLÈTE qui assène après une
> explication, pas une énumération saucissonnée en points. **Corrigé** : les chiffres sont maintenant DANS
> une seule phrase construite ("un accord de vingt-cinq ans, qui autoriserait jusqu'à trois cents soldats
> russes et quatre navires de guerre..."), pas éclatés en fragments.
> **2e leçon Aziz, même passage** : "longtemps" (flou temporel) → remplacé par un ancrage daté précis
> ("depuis le début de la guerre, il y a trois ans") quand la donnée existe — la précision temporelle est
> plus forte ET plus vérifiable qu'un adverbe vague.
> **3e correction (Aziz, re-relecture)** : (a) beat 2 — "une base pour sa marine — un accord de 25 ans"
> (2 groupes nominaux juxtaposés par un tiret) → liaison par "et" ("une base pour sa marine ET un accord
> de vingt-cinq ans") pour une vraie phrase reliée plutôt que deux blocs collés. (b) beat 4 — même défaut
> que "longtemps" : "en juin dernier" reste une approximation relative (devient fausse/datée dans 6 mois-1
> an) → remplacé par la date exacte vérifiée "le 21 juin 2026". **Règle gravée pour l'Acte 5 et au-delà** :
> quand une date/durée EXACTE existe dans les données vérifiées, l'écrire en dur (jour/mois/année ou durée
> chiffrée), jamais une approximation relative ("dernier", "récemment", "il y a quelque temps") qui périme
> avec le temps et oblige une relecture pour vérifier si c'est encore vrai. Le relatif n'est acceptable que
> quand la donnée elle-même n'a pas de date précise sourcée.

- [x] Zéro phrase sans verbe (relu ligne par ligne)
- [x] Un connecteur de présence narrateur par beat ("Et ce revirement, Moscou le fait payer cher...", "Rien n'est encore signé. Mais personne...", "Ce ne sont donc plus...")
- [x] "on/nous" implicite, aucun "tu"
- [x] 1 idée/phrase ≤22 mots — **et re-testé à l'oreille cette fois**, pas juste au compte-mots : le beat 2 est maintenant en phrases courtes séparées ("Vingt-cinq ans." / "Jusqu'à trois cents soldats russes." / "Quatre navires de guerre...") plutôt qu'une seule phrase-liste qui empile 4 chiffres.
- [x] Tampon sur nom propre au 1er passage : "Moscou" porté par le verbe "changer de camp" (beat 1) ; "Kosti" nommé pour un fait civil vérifié, sans tampon oral explicite mais compensé par le repère visuel carte.
- [x] Paradoxe affirmé nu, pas de question rhétorique annoncée (beat 1 : "il vient de changer de camp" frappe direct)
- [x] Rythme syncopé (règle 14) : le beat 2 alterne maintenant une vraie montée orale (3 phrases courtes de chiffres, rythme qui s'accélère) puis la chute ("Rien n'est encore signé. Mais personne, à Moscou, n'a retiré cette demande.") — plus proche d'un débit parlé que la version-liste précédente.
- [x] **Test à voix haute (règle Tremblay, re-fait après signal d'Aziz)** : chaque phrase relue comme en conversation. Beat 1/2/3 corrigés pour que chaque sujet AGISSE ("elle a fait volte-face", "elle négocie", "elle renseigne... et coordonne") plutôt que des tournures passives/nominales empilées.
- [x] Longueur orale v2 ~135-155 mots (~55-65s) — cohérent avec le rythme syncopé voulu, plus court qu'Acte 3.
- [x] Show-don't-tell : validé + renforcé par le jury (Nil illuminé au beat 4, compteur simplifié au beat 2, Kosti recadré sur l'internationalisation générale au beat 5).

...
## SECTION — Une scène par session (rapatrié de rules-workflow-processus.md, archivé 2026-07-11)

Issues de la session Beat 1 Ghana trop lourde (R&D + audit + prod mélangés) :

1. **1 session = 1 beat** : ne pas mélanger R&D + production.
2. **ATLAS-COMPOSANTS.md en premier** : lire avant d'écrire une ligne.
3. **Screenshot dès v1 ratée** : lire l'image avant de proposer la v2.

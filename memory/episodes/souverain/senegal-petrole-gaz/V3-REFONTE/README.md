...
| 4 | le piège de la dette (terrain 2) | Beat12 (calebasse 132%) | 🟡 **À 95%** — concept BARRAGE validé Aziz (mur FONSIS, dette rouge déborde 132%, brèche/vidange tricolore vers BUDGET, FMI statique, mur gauche disparaît). Codé par AGENT autonome (test système concluant). Reste 2 fixes (fissure nette + bac immobile) → `REPRISE-SCENE-4-DETTE.md`. Render : `wip/scene4-barrage-v3.mp4` (catbox qvx8j0). | `beats/SceneDetteV3.tsx` |

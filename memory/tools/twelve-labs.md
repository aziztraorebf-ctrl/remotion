...
- **Review finale rythme/rétention/ton** → **Gemini 3.1 Pro video upload** couvre déjà ce rôle (validé fiable depuis 2026-06-16, cf. `memory/tools/gemini-video-upload-fiable.md`) et fait mieux pour nos formats courts (90-166s) : mouvement, rythme, transitions, son.

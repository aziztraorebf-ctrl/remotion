...
| Fichier | Contenu |
|---|---|
| **`minimax-h3-styles-tests.md`** ⭐⭐⭐ | Tests de styles visuels (Hand Drawn, Poster Vector — inspirés Higgsfield Explainer), workflow standard 480p→720p→upscale validé, dossier de référence consolidé (2026-08-13) |
| **`minimax-h3-comfy-cloud.md`** ⭐⭐⭐ | Voie GRATUITE principale (open-weight, inclus abonnement) — guide de prompting officiel, format 6-sections, node IDs, tous les tests réels (Sonjata, NoteShield, Flowdesk, Pêcheur, Mariama Bâ...). **Toujours essayer en premier.** |

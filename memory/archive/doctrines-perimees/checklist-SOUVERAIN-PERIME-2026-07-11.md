...
# Checklist Souverain — Vivante & Contraignante — ⛔ ARCHIVÉ 2026-07-11

> **PÉRIMÉ — remplacé par le skill `souverain-preproduction`.** Jury LLM (GPT-4o+Grok) périmé, entry point
> `src/index.ts` contredit par la pratique réelle (`Root.tsx`), script Kimi mort (`review_with_kimi.py`
> n'existe plus). Jamais routé (ni ROUTAGE.md ni MEMORY.md) — trouvé orphelin lors de l'audit 2026-07-11.

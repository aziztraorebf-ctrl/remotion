"""Pre-test 4 mots problematiques Mansa Moussa avant narration complete.
...
PRETEST = """Cet homme s'appelait Mansa Moussa.

Demande qui est l'homme le plus riche de l'histoire. On te repondra Rockefeller, Bezos, Musk. Pas lui."""

OUT_DIR = ROOT / "quebec-jacques-poc" / "out" / "atlas-mansa-moussa"
OUT_DIR.mkdir(parents=True, exist_ok=True)
OUT_FILE = OUT_DIR / "pretest-words.mp3"
...
def main() -> int:
    ...
    print("Generating pretest audio...")

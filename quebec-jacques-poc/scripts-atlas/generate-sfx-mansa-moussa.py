"""Generate SFX for Atlas Mansa Moussa.
B x3: impact villes (Tombouctou, Caire, La Mecque) — wax seal stamp
C: ink-draw caravane route (Mali -> Caire -> Mecque)
D: cartouche thud (stat 12 tonnes / 12 ans / etc)
E: vent Sahara diegetic (scene 3 traversee desert)
"""
import os
import sys
...
OUT_DIR = ROOT / "quebec-jacques-poc" / "out" / "atlas-mansa-moussa" / "sfx"
...
SFX_DEFS = [
    ...
    {
        "name": "E-vent-sahara",
        "prompt": "Distant desert wind blowing across vast sand dunes, low whoosh with subtle sand particles, atmospheric and immersive, no music, no voices, gentle and continuous, 6 seconds",
        "duration": 6.0,
        "prompt_influence": 0.4,
    },
]
